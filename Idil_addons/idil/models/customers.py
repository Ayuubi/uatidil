...
class Customer(models.Model):
    _name = 'idil.customer.registration'  # Replace 'your.module.customer' with your module's name
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = 'Customer Registration'

    name = fields.Char(string='Name', required=True, tracking=True)
    type_id = fields.Many2one(comodel_name='idil.customer.type.registration', string='CustomerType',
